...
void init_ADC0_single(void)  {
  ...
  ADC0->CFG1 &= ~ADC_CFG1_MODE(0b11);      /* 12-bit conversion */
...
uint32_t read_ADC0_single(uint16_t inputChannel)  {
  ...
  ADC0->SC1[0] &= ~ADC_SC1_ADCH(0b111111); /* Clear prior ADCH bits */
